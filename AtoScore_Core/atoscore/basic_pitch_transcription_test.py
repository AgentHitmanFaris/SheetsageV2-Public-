...
class TestBasicPitchTranscription(unittest.TestCase):
    ...
    @patch("atoscore.basic_pitch_transcription.atoscore")
    @patch("atoscore.basic_pitch_transcription.predict_and_save")
    @patch("atoscore.basic_pitch_transcription.tempfile.TemporaryDirectory")
    @patch("atoscore.basic_pitch_transcription.LeadSheet")
    def test_transcribe_basic_pitch_success(self, mock_LeadSheet, mock_temp_dir, mock_predict, mock_atoscore):
        # Setup mock temp dir
        ...
        # Mock atoscore return value (lead_sheet, beats, beat_times)
        mock_ls = MagicMock()
        ...
        mock_atoscore.return_value = (mock_ls, list(range(10)), list(range(10)))

        # Mock PrettyMIDI
        with patch("atoscore.basic_pitch_transcription.pretty_midi.PrettyMIDI") as MockPM:
            ...
            with patch("atoscore.basic_pitch_transcription.engrave") as mock_engrave, \
                ...
                mock_atoscore.assert_called_once()
