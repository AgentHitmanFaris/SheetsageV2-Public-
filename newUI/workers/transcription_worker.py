...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'SheetSage_Core')))
...
class TranscriptionWorker(QThread):
    ...
    def _transcribe_lead_sheet(self):
        ...
        from sheetsage.audio_utils import synthesize_midi, create_mix
        from sheetsage.utils import engrave
        from sheetsage.config_manager import current_config
        import os
    ...
    def _transcribe_lunaverus(self):
        ...
        weights_path = os.path.join(os.path.dirname(__file__), '..', '..', 'SheetSage_Core', 
                                    'sheetsage', 'modules', 'lunaverus_weights.pth')
