...
class TestUtils(unittest.TestCase):
    ...
    @patch("sheetsage.theory.utils.run_cmd_sync")
    def test_estimate_key_changes(self, mock_run):
        meter_changes = MeterChanges((0, (4, 2, 2)))

        # Helper to set mock return
        def set_mock_key(key_str):
            mock_run.return_value = (0, key_str, "")
        ...
        mock_run.return_value = (0, "", "") # Empty output -> failure
