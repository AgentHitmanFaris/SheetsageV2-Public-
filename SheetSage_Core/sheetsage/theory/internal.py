...
class Meter(_ImmutableIterable):
    """
    Represents a musical meter.

    Structure:
    - Primary subdivision: number of pulses per bar (e.g., 3 or 4)
    - Secondary subdivision: division of pulse (2 for simple, 3 for compound)
    - Tertiary subdivision: further quantization
    """
    ...
    def as_lily(self):
        """
        Returns the LilyPond representation of the meter.
        """
...
class Tempo(_ImmutableIterable):
    """
    Represents tempo in pulses per minute.
    """
    ...
    def as_lily(self, meter):
        """
        Returns the LilyPond representation of the tempo.
        """
...
class Key(_ImmutableIterable):
    ...
    def as_lily(self):
        """
        Returns the LilyPond representation of the key.
        """
...
class Note(_ImmutableIterable):
    ...
    def as_lily(self, key, octave_0=4):
        """
        Returns the LilyPond representation of the note.
        """
    ...
    def as_midi_pitch(self, octave_0=4):
        """
        Returns the MIDI pitch value of the note.
        """
...
class Chord(_ImmutableIterable):
    ...
    def as_lily(self, key):
        """
        Returns the LilyPond representation of the chord.
        """
        if not isinstance(key, Key):
            raise TypeError()
        if self[0] is None:
    ...
    def as_midi_pitches(self, octave_0=3):
        """
        Returns the MIDI pitches of the chord notes.
        """
        if self[0] is None:
            assert self[1] is None
            result = []
...
class MeterChanges(_DefinedAtStartInstantEventList):
    """
    List of meter changes, defined at start.
    """
...
class TempoChanges(_DefinedAtStartInstantEventList):
    """
    List of tempo changes, defined at start.
    """
    def __new__(cls, *args):
...
class KeyChanges(_DefinedAtStartInstantEventList):
    """
    List of key changes, defined at start.
    """
    def __new__(cls, *args):
