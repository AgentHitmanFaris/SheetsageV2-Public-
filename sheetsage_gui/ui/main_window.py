...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.temp_base = os.path.join(os.path.dirname(__file__), '..', '..', 'SheetSage_Core', 'temp_projects')
    ...
    def _save_project_as(self):
        ...
        try:
            import sys
            sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..', 'SheetSage_Core'))
            from sheetsage.project_bundle import create_project_bundle
...
"""
    ...
    def _on_compress_output(self):
        ...
        folder = QFileDialog.getExistingDirectory(
            ...
            os.path.join(os.getcwd(), '..', 'SheetSage_Core', 'output')
        )
    ...
    def _load_project_bundle(self, file_path):
        ...
        try:
            import sys
            sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..', 'SheetSage_Core'))
            from sheetsage.project_bundle import extract_project_bundle, get_bundle_info
